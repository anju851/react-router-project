...
const UserProfile = () => {
  ...
  //whatever value is passed after the colon in the url is taken as parameter of the url and is extracted using useParams here  and used in the code or for dynamic routing or param fetch from url
